...
void blur(int dim, float *img, float *flt, float *dst) 
{
    ...
    flt21 = *(flt+5); flt22 = *(flt+6); flt23 = *(flt+7); flt24 = *(flt+8); flt25 = *(flt+9);
    flt31 = *(flt+10); flt32 = *(flt+11); flt33 = *(flt+12); flt34 = *(flt+13); flt35 = *(flt+14);
    flt41 = *(flt+15); flt42 = *(flt+16); flt43 = *(flt+17); flt44 = *(flt+18); flt45 = *(flt+19);
    flt51 = *(flt+20); flt52 = *(flt+21); flt53 = *(flt+22); flt54 = *(flt+23); flt55 = *(flt+24);
